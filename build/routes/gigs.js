...
router.post("/add", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, budget, contact_email, description, technologies, title, errors, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, budget = _a.budget, contact_email = _a.contact_email, description = _a.description, technologies = _a.technologies, title = _a.title;
                errors = [];
                if (!title) {
                    errors.push({
